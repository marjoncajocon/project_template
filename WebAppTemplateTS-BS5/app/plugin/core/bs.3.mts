...
enum FaIcons {
    ...
    AddressBookO = "fa-address-book",
    AddressCard = "fa-address-card",
    AddressCardO = "fa-address-card",
    Adjust = "fa-adjust",
    Adn = "fa-adn",
    ...
    BookmarkO = "fa-bookmark",
    Braille = "fa-braille",
    Briefcase = "fa-briefcase",
    Btc = "fa-btc",
    Bug = "fa-bug",
    Building = "fa-building",
    BuildingO = "fa-building",
    ...
    CalendarCheckO = "fa-calendar-check",
    CalendarMinusO = "fa-calendar-minus",
    CalendarO = "fa-calendar",
    CalendarPlusO = "fa-calendar-plus",
    CalendarTimesO = "fa-calendar-times",
    Camera = "fa-camera",
    ...
    CheckCircleO = "fa-check-circle",
    CheckSquare = "fa-check-square",
    CheckSquareO = "fa-check-square",
    ...
    CommentingO = "fa-commenting",
    Comments = "fa-comments",
    CommentsO = "fa-comments",
    Compass = "fa-compass",
    ...
    Digg = "fa-digg",
    Dollar = "fa-dollar",
    DotCircleO = "fa-dot-circle",
    Download = "fa-download",
    Dribbble = "fa-dribbble",
    DriversLicense = "fa-drivers-license",
    DriversLicenseO = "fa-drivers-license",
    Dropbox = "fa-dropbox",
    Drupal = "fa-drupal",
    Edge = "fa-edge",
    Edit = "fa-edit",
    ...
    EnvelopeO = "fa-envelope",
    EnvelopeOpen = "fa-envelope-open",
    EnvelopeOpenO = "fa-envelope-open",
    ...
    File = "fa-file",
    FileArchiveO = "fa-file-archive",
    FileAudioO = "fa-file-audio",
    FileCodeO = "fa-file-code",
    FileExcelO = "fa-file-excel",
    FileImageO = "fa-file-image",
    FileMovieO = "fa-file-movie",
    FileO = "fa-file",
    FilePdfO = "fa-file-pdf",
    FilePhotoO = "fa-file-photo",
    FilePictureO = "fa-file-picture",
    FilePowerpointO = "fa-file-powerpoint",
    FileSoundO = "fa-file-sound",
    FileText = "fa-file-text",
    FileTextO = "fa-file-text",
    FileVideoO = "fa-file-video",
    FileWordO = "fa-file-word",
    FileZipO = "fa-file-zip",
    FilesO = "fa-files",
    Film = "fa-film",
    Filter = "fa-filter",
    Fire = "fa-fire",
    ...
    HandGrabO = "fa-hand-grab",
    HandLizardO = "fa-hand-lizard",
    HandODown = "fa-hand-o-down",
    HandOLeft = "fa-hand-o-left",
    HandORight = "fa-hand-o-right",
    HandOUp = "fa-hand-o-up",
    HandPaperO = "fa-hand-paper",
    HandPeaceO = "fa-hand-peace",
    HandPointerO = "fa-hand-pointer",
    HandRockO = "fa-hand-rock",
    HandScissorsO = "fa-hand-scissors",
    HandSpockO = "fa-hand-spock",
    HandStopO = "fa-hand-stop",
    HandshakeO = "fa-handshake",
    ...
    PlayCircleO = "fa-play-circle",
    Plug = "fa-plug",
    Plus = "fa-plus",
    PlusCircle = "fa-plus-circle",
    PlusSquare = "fa-plus-square",
    PlusSquareO = "fa-plus-square",
    Podcast = "fa-podcast",
    ...
    QuestionCircleO = "fa-question-circle",
    Quora = "fa-quora",
    ...
    SnowflakeO = "fa-snowflake",
    SoccerBallO = "fa-soccer-ball",
    Sort = "fa-sort",
    ...
    StickyNoteO = "fa-sticky-note",
    Stop = "fa-stop",
    StopCircle = "fa-stop-circle",
    StopCircleO = "fa-stop-circle",
    ...
    TimesCircleO = "fa-times-circle",
    TimesRectangle = "fa-times-rectangle",
    TimesRectangleO = "fa-times-rectangle",
    Tint = "fa-tint",
